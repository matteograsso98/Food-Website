"""
Django settings for my_food_blog project.
...
SECRET_KEY = 'django-insecure-$=t(!y5q71=#v0olgbs*jqohq7w=-g1*@jya44=t!89^&tj!wd'
...
ROOT_URLCONF = 'my_food_blog.urls'
...
WSGI_APPLICATION = 'my_food_blog.wsgi.application'
